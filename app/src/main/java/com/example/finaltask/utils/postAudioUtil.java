...
import com.example.finaltask.common.ConnUtil;
import com.example.finaltask.common.DemoException;
import com.example.finaltask.common.TokenHolder;
...
public class postAudioUtil {

    private final boolean METHOD_RAW = false; // 默认以json方式上传音频文件

    //  填写网页上申请的appkey 如 $apiKey="g8eBUMSokVB1BHGmgxxxxxx"
    private final String APP_KEY = "H1Vn48FxGgwTiGBIlpglvwVD";

    // 填写网页上申请的APP SECRET 如 $SECRET_KEY="94dc99566550d87f8fa8ece112xxxxx"
    private final String SECRET_KEY = "RGgSayFbmf4PSPeBxnt6NUNz2HCkoTHg";
